...
// import { applyDefaultChangeListener } from './command';
...
export class Hydration {
  ...
  public process(mutations: any[]): void {
    ...
    //       if (nodeToAdd.transfered === NumericBoolean.FALSE) {
    //         const baseNode =
   ...
   */
  // private hydrateElement_(node: RenderableElement, skeleton: any): void {
   ...
   * @param skeleton Skeleton Node representation created by WorkerDOM and transmitted across threads.
   */
  // private hydrateNode_(node: Node, skeleton: any): void {
