...
function (_Component2) {
  ...
  _proto2.render = function render$$1(_ref) {
    ...
    }, lastSample.nbQueries)), lastSample.topFiveQueries.map(function (query, index) {
      return h(Query, {
        key: index,
        query: query.query,
...
function (_Component3) {
  ...
  function Databases() {
    ...
    return (_temp = _this = _Component3.call.apply(_Component3, [this].concat(args)) || this, Object.defineProperty(_assertThisInitialized(_this), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
  ...
  _proto3.render = function render$$1(_, state) {
    return h("tbody", null, state.databases.map(function (database) {
      return h(Database, {
        key: database.dbname,
...
function (_Component4) {
  ...
  function DBMon() {
    ...
    return (_temp2 = _this2 = _Component4.call.apply(_Component4, [this].concat(args)) || this, Object.defineProperty(_assertThisInitialized(_this2), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
  ...
  _proto4.render = function render$$1(_, state) {
    return h("div", null, h("div", {
      ...
      id: "ratioval"
    }, "mutations: ", (state.mutations * 100).toFixed(0), "%"), h("input", {
      type: "range",
...
function (_Component) {
  ...
  _proto.render = function render$$1(props, state) {
    return h("div", null, h("p", null, "Hello ", props.name, "! Button was clicked? ", state.clicked), h("button", {
...
var TodoList = function TodoList(props) {
  return h("ul", null, props.items.map(function (item) {
    return h("li", {
      key: item.id
    }, item.text);
  }));
...
function (_Component2) {
  ...
  function TodoApp() {
    ...
    return (_temp = _this2 = _Component2.call.apply(_Component2, [this].concat(args)) || this, Object.defineProperty(_assertThisInitialized(_this2), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
  ...
  _proto2.render = function render$$1(_, state) {
    return h("div", null, h("h3", null, "TODO"), h(TodoList, {
      items: state.items
    }), h("input", {
...
function (_Component3) {
  ...
  function Timer() {
    ...
    return (_temp2 = _this3 = _Component3.call.apply(_Component3, [this].concat(args)) || this, Object.defineProperty(_assertThisInitialized(_this3), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
