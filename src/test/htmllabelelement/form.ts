...
test('form should return direct parent when a child of a form', t => {
  const { element, form } = t.context as { element: HTMLLabelElement; form: Element };
...
test('form should return only form parent when deeply nested', t => {
  const { element, form, intermediary } = t.context as { element: HTMLLabelElement; form: Element; intermediary: Element };
...
test('form should return null when there is no parent form element', t => {
  const { element, intermediary } = t.context as { element: HTMLLabelElement; intermediary: Element };
